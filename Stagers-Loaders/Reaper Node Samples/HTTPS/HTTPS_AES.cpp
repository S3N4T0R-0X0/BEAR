// x86_64-w64-mingw32-g++ -o HTTPS_AES.exe HTTPS_AES.cpp -lwininet -lcrypt32 -lws2_32 -static -std=c++17 -lstdc++fs
...
const string AUTH_ID = "78c45435-38d1-4b77-8a6b-c524be51fa14";
...
bool checkin() {
    try {
        ...
        if (session_id.empty() || session_id.find("HTTPS - AES - ") == string::npos) {
            return false;
        }
